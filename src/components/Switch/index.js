...
class MaterialSwitch extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      position: new Animated.Value(
        this.props.active ? w : this.props.buttonOffset
      ),
    };
  }
  ...
  componentWillReceiveProps(nextProps) {
    if (this.state.state !== nextProps.active) {
      nextProps.active ? this.activate() : this.deactivate(); // eslint-disable-line
    }
  }
  ...
  render() {
    ...
    return (
      <View
        ...
        style={[
          { padding: this.padding, position: 'relative' },
          this.props.style,
        ]}
      >
        <View
...
MaterialSwitch.propTypes = propTypes;
